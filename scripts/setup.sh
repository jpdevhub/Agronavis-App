...
echo ""
echo "${BOLD}${YELLOW}⚠️  Next Steps:${RESET}"
...
echo ""
echo "${BOLD}Then start development:${RESET}"
echo "  ${GREEN}npm run dev:backend${RESET}   → Start API server on :3001"
echo "  ${GREEN}npm run dev:mobile${RESET}    → Start Expo"
echo "  ${GREEN}npm run dev${RESET}           → Start both concurrently"
echo ""
