-- =============================================================================
-- Agronavis — Safe Additive Migration (v2)
-- Paste the full contents into Supabase SQL Editor and click Run.
--
-- RULES:
--   • ADDITIVE ONLY — never drops a live table, column, or policy.
--   • Every CREATE TABLE uses IF NOT EXISTS.
--   • Every ALTER TABLE column uses IF NOT EXISTS.
--   • farm_fields is created FIRST so the crops.field_id FK is always valid.
-- =============================================================================
